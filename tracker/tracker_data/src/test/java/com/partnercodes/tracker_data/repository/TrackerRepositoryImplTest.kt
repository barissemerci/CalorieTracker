...
import com.partnercodes.tracker_data.remote.malformedFoodResponse
import com.partnercodes.tracker_data.remote.validFoodResponse
...
class TrackerRepositoryImplTest {
    ...
    fun setUp() {
        ...
        api = Retrofit.Builder().addConverterFactory(MoshiConverterFactory.create())
